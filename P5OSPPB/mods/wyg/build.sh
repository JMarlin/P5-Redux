...
ld -o wyg.o -T lscpt.lds init.o main.o associativearray.o button.o context.o desktop.o list.o listnode.o object.o rect.o styleutils.o textbox.o window.o -melf_i386 ../lib/p5.o ../lib/p5s.o ../lib/memory.o ../lib/memorys.o ../lib/gfx.o ../lib/key.o ../lib/mouse.o -g 
