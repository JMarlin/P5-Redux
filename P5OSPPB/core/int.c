...
void installExceptionHandlers() {
    ...
    installInterrupt(0x0, &_expt_zeroDivide, 0);
    installInterrupt(0x1, &_expt_debugCall, 0);
    installInterrupt(0x2, &_expt_NMI, 0);
    installInterrupt(0x3, &_expt_breakpoint, 3);
    installInterrupt(0x4, &_expt_overflow, 0);
    installInterrupt(0x5, &_expt_outOfBound, 0);
    installInterrupt(0x6, &_expt_illegalOpcode, 0);
    installInterrupt(0x7, &_expt_noCoprocessor, 0);
    installInterrupt(0x8, &_expt_doubleFault, 0);
    installInterrupt(0xA, &_expt_invalidTSS, 0);
    installInterrupt(0xB, &_expt_segNotPresent, 0);
    installInterrupt(0xC, &_expt_stackFault, 0);
    installInterrupt(0xD, &_expt_generalProtection, 0);
    installInterrupt(0xE, &_expt_pageFault, 0);
    installInterrupt(0x10, &_expt_mathFault, 0);
    installInterrupt(0x11, &_expt_alignCheck, 0);
    installInterrupt(0x12, &_expt_machineCheck, 0);
    installInterrupt(0x13, &_expt_simdFailure, 0);

    //And the syscall interface
    installInterrupt(0xFE, &_expt_forceenter, 3);
    installInterrupt(0xFF, &_expt_syscall, 3);
}
