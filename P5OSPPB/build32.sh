...
C_OPTS="-nostdlib -nostartfiles -nodefaultlibs -nostdinc -ffreestanding -g" # -fno-zero-initialized-in-bss"

cd core
echo Starting core build...
as -o ../build/syscalls.o syscall.s -g 
...
as -o ../build/expt.o expt.s -g 
as -o ../build/irqs.o irq.s -g 
...
as -o ../build/pagings.o paging.s -g 
...
as -o ../build/processs.o process.s -g 
